...
def cook():
	t1 = Thread(target = scrape, args = ('https://shop.bdgastore.com', 31656294152, 31662054152, '1', 'BDGA'))
	t2 = Thread(target = scrape, args = ('https://shop.bdgastore.com', 31667814216, 31673574280, '2', 'BDGA'))
