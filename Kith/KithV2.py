...
def Cook():
	...
	t1 = Thread(target = scrape, args = ('https://kithnyc.com', (33792828231+64)))
	t2 = Thread(target = scrape, args = ('https://kithnyc.com', (34102325575+64)))
	t3 = Thread(target = scrape, args = ('https://kithnyc.com', (34319225287+64)))
